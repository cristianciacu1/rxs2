...
export default function LeftPortfolio(props) {
    ...
    return(
        <Row>
            <Col sm={12} md={8} lg={8} xl={8} className="paddingBottom">
                        ...
                        <h1 className=" text-center font2 titleSuccess" style={{color: 'black', fontSize: 48, fontWeight: 100}}>
                              <Link to={props.categoryLink}><b className="text-uppercase">{props.categoryName}</b></Link>
                              <div className="lineUnder" />
                              <p className="text-center" style={{fontSize: 22, color: '#2f3640'}}>{props.categoryDesc}</p>
                          </h1>
                        </div>
                      </Col>
                      <Col sm={12} md={4} lg={4} xl={4} className="paddingBottom">
